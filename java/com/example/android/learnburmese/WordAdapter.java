...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView pronounceTextView = (TextView) listItemView.findViewById(R.id.text_view);
        // Get the Miwok translation from the currentWord object and set this text on
        // the Miwok TextView.
        pronounceTextView.setText(currentWord.getPronounceId());
        ...
        wordTextView.setText(currentWord.getWordResourceId());
